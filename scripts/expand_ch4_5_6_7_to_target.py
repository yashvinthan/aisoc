"""
Direct script to expand Chapters 4, 5, 6, and 7 with rich technical depth and compile the master report.
"""

# Let's enrich ch4_gen.py
ch4_expanded = '''"""
...
def generate_chapter_4(add_p, add_ch_heading, add_sec_heading, add_subsec_heading, add_code, add_table, add_fig, fig_dir):
    ...
    add_p("Under this paradigm, every ingested event is immediately evaluated in the context of the enterprise topology. An isolated authentication failure is correlated with concurrent network egress from the same host, prior administrative privilege escalations, and known threat actor infrastructure.")
