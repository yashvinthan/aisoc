"""
Master Assembly Script to produce a complete 15,200+ words Academic B. Tech Report in .docx format with:
- All 10 user-requested live application & CLI screenshots
