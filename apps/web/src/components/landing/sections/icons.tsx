...
/**
 * Small bag of brand SVGs the marketing landing page needs that aren't
 * available in `lucide-react` (brand icons were removed from the package
 * around v0.469). Keep these inline so the landing route never reaches
 * for a font-icon library or pulls a second copy of the GitHub mark.
 *
 * Geometry copied from the official GitHub Octicons mark (MIT-licensed).
 */
